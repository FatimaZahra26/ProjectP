...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/budgets/update', [HomeController::class, 'updateBudget'])->name('budgets.update');
    ...
    Route::delete('/expenses/{id}', [HomeController::class, 'deleteExpense'])->name('expenses.delete');
    Route::post('/expenses', [HomeController::class, 'updateExpense'])->name('expenses.update');
});
